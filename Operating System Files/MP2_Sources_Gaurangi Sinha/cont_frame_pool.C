                             ...
                             unsigned long infoFrameNumber)
{
    ...
    assert(numberOfFrames * 2 <= FRAME_SIZE * 8);
...
unsigned long ContFramePool::allocate_frames(unsigned int framesNeeded)
{
...
void ContFramePool::release_allocated_frames(unsigned long firstFrameNumber)
{
...
unsigned long ContFramePool::calculate_needed_info_frames(unsigned long frames)
{
